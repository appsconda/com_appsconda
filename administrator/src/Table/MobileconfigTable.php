 ...
 * Appsconda table
 */
class MobileconfigTable extends Table
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct('#__appsconda_mobileconfigs', 'id', $db);
    }
    ...
    public function bind($array, $ignore = '')
    {
        ...
        if(!Factory::getUser()->authorise('core.admin', 'com_appsconda.mobileconfig.'.$array['id']))
        {
            $actions = Factory::getACL()->getActions('com_appsconda','mobileconfig');
            $default_actions = Factory::getACL()->getAssetRules('com_appsconda.mobileconfig.'.$array['id'])->getData();
            $array_jaccess = array();
    ...
    {
        $k = $this->_tbl_key;
        return 'com_appsconda.mobileconfig.' . (int) $this->$k;
    }
