 ...
 * Appsconda table
 */
class CustompageTable extends Table
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct('#__appsconda_custompages', 'id', $db);
    }
    ...
    public function bind($array, $ignore = '')
    {
        ...
        if(!Factory::getUser()->authorise('core.admin', 'com_appsconda.custompage.'.$array['id']))
        {
            $actions = Factory::getACL()->getActions('com_appsconda','custompage');
            $default_actions = Factory::getACL()->getAssetRules('com_appsconda.custompage.'.$array['id'])->getData();
            $array_jaccess = array();
    ...
    {
        $k = $this->_tbl_key;
        return 'com_appsconda.custompage.' . (int) $this->$k;
    }
