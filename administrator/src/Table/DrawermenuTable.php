 ...
 * Appsconda table
 */
class DrawermenuTable extends Table
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct('#__appsconda_drawermenus', 'id', $db);
    }
    ...
    public function bind($array, $ignore = '')
    {
        ...
        if(!Factory::getUser()->authorise('core.admin', 'com_appsconda.drawermenu.'.$array['id']))
        {
            $actions = Factory::getACL()->getActions('com_appsconda','drawermenu');
            $default_actions = Factory::getACL()->getAssetRules('com_appsconda.drawermenu.'.$array['id'])->getData();
            $array_jaccess = array();
    ...
    {
        $k = $this->_tbl_key;
        return 'com_appsconda.drawermenu.' . (int) $this->$k;
    }
