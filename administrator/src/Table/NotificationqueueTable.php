...
class NotificationqueueTable extends Table
{
    ...
    {
        parent::__construct('#__appsconda_notificationqueues', 'id', $db);
    }
    ...
    public function bind($array, $ignore = '')
    {
        ...
        if(!Factory::getUser()->authorise('core.admin', 'com_appsconda.notificationqueue.'.$array['id']))
        {
            $actions = Factory::getACL()->getActions('com_appsconda','notificationqueue');
            $default_actions = Factory::getACL()->getAssetRules('com_appsconda.notificationqueue.'.$array['id'])->getData();
            $array_jaccess = array();
    ...
    {
        $k = $this->_tbl_key;
        return 'com_appsconda.notificationqueue.' . (int) $this->$k;
    }
