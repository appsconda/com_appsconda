 ...
 * Appsconda table
 */
class MobiledeviceTable extends Table
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct('#__appsconda_mobiledevices', 'id', $db);
    }
    ...
    public function bind($array, $ignore = '')
    {
        ...
        if(!Factory::getUser()->authorise('core.admin', 'com_appsconda.mobiledevice.'.$array['id']))
        {
            $actions = Factory::getACL()->getActions('com_appsconda','mobiledevice');
            $default_actions = Factory::getACL()->getAssetRules('com_appsconda.mobiledevice.'.$array['id'])->getData();
            $array_jaccess = array();
    ...
    {
        $k = $this->_tbl_key;
        return 'com_appsconda.mobiledevice.' . (int) $this->$k;
    }
