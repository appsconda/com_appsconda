 ...
 * Appsconda table
 */
class CompilationTable extends Table
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct('#__appsconda_compilations', 'id', $db);
    }
    ...
    public function bind($array, $ignore = '')
    {
        ...
        if(!Factory::getUser()->authorise('core.admin', 'com_appsconda.compilation.'.$array['id']))
        {
            $actions = Factory::getACL()->getActions('com_appsconda','compilation');
            $default_actions = Factory::getACL()->getAssetRules('com_appsconda.compilation.'.$array['id'])->getData();
            $array_jaccess = array();
    ...
    {
        $k = $this->_tbl_key;
        return 'com_appsconda.compilation.' . (int) $this->$k;
    }
