...
class PublicationTable extends Table
{
    ...
    {
        parent::__construct('#__appsconda_publications', 'id', $db);
    }
    ...
    public function bind($array, $ignore = '')
    {
        ...
        if(!Factory::getUser()->authorise('core.admin', 'com_appsconda.publication.'.$array['id']))
        {
            $actions = Factory::getACL()->getActions('com_appsconda','publication');
            $default_actions = Factory::getACL()->getAssetRules('com_appsconda.publication.'.$array['id'])->getData();
            $array_jaccess = array();
    ...
    {
        $k = $this->_tbl_key;
        return 'com_appsconda.publication.' . (int) $this->$k;
    }
