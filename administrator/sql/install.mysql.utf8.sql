...
CREATE TABLE IF NOT EXISTS `#__appsconda_webviewmenus` (
  ...
  `menu12access` varchar(5) NOT NULL,
  ...
  `menu13access` varchar(5) NOT NULL,
  ...
  `menu14access` varchar(5) NOT NULL,
  ...
  `menu15access` varchar(5) NOT NULL,
...
INSERT INTO `#__appsconda_webviewmenus` (`id`, `menu1show`, `menu1label`, `menu1color`, `menu1icon`, `menu1access`, `menu1content`, `menu2show`, `menu2label`, `menu2color`, `menu2icon`, `menu2access`, `menu2content`, `menu3show`, `menu3label`, `menu3color`, `menu3icon`, `menu3access`, `menu3content`, `menu4show`, `menu4label`, `menu4color`, `menu4icon`, `menu4access`, `menu4content`, `menu5show`, `menu5label`, `menu5color`, `menu5icon`, `menu5access`, `menu5content`, `menu6show`, `menu6label`, `menu6color`, `menu6icon`, `menu6access`, `menu6content`, `menu7show`, `menu7label`, `menu7color`, `menu7icon`, `menu7access`, `menu7content`, `menu8show`, `menu8label`, `menu8color`, `menu8icon`, `menu8access`, `menu8content`, `menu9show`, `menu9label`, `menu9color`, `menu9icon`, `menu9access`, `menu9content`, `menu10show`, `menu10label`, `menu10color`, `menu10icon`, `menu10access`, `menu10content`, `menu11show`, `menu11label`, `menu11color`, `menu11icon`, `menu11access`, `menu11content`, `menu12show`, `menu12label`, `menu12color`, `menu12icon`, `menu12access`, `menu12content`, `menu13show`, `menu13label`, `menu13color`, `menu13icon`, `menu13access`, `menu13content`, `menu14show`, `menu14label`, `menu14color`, `menu14icon`, `menu14access`, `menu14content`, `menu15show`, `menu15label`, `menu15color`, `menu15icon`, `menu15access`, `menu15content`, `created_by`, `state`, `ordering`) VALUES
(1, 'false', '', '', '', 'false', '', 'false', '', '', '', 'false', '', 'false', '', '', '', 'false', '', 'false', '', '', '', 'false', '', 'false', '', '', '', 'false', '', 'false', '', '', '', 'false', '', 'false', '', '', '', 'false', '', 'false', '', '', '', 'false', '', 'false', '', '', '', 'false', '', 'false', '', '', '', 'false', '', 'false', '', '', '', 'false', '', 'false', '', '', '', 'false', '', 'false', '', '', '', 'false', '', 'false', '', '', '', 'false', '', 'false', '', '', '', 'false', '', 0, 1, 0);
