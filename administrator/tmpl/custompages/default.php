...
<form action="<?php echo JRoute::_('index.php?option=com_appsconda&view=custompages'); ?>" method="post" name="adminForm" id="adminForm" data-list-order="<?php echo $listOrder; ?>">
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			<?php endif;?>
			<table class="table table-striped" id="custompageList">
				<thead>
					<tr>
						...
						<th class="left">
							<?php echo HTMLHelper::_('grid.sort',  'COM_APPSCONDA_HEADING_BACKEND_LIST_CUSTOMPAGES_NAME', 'a.name', $listDirn, $listOrder); ?>
						</th>
						<th class="left">
							<?php echo HTMLHelper::_('grid.sort',  'COM_APPSCONDA_HEADING_BACKEND_LIST_CUSTOMPAGES_CREATED_BY', 'a.created_by', $listDirn, $listOrder); ?>
						</th>
						<th class="left">
							<?php echo HTMLHelper::_('grid.sort',  'COM_APPSCONDA_HEADING_BACKEND_LIST_CUSTOMPAGES_STATE', 'a.state', $listDirn, $listOrder); ?>
						</th>
						<th width="1%" class="nowrap">
							<?php echo HTMLHelper::_('grid.sort', 'COM_APPSCONDA_HEADING_BACKEND_LIST_CUSTOMPAGES_ID', 'a.id', $listDirn, $listOrder); ?>
						</th>
					</tr>
				</thead>
