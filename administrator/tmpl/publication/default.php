...
/** @var \Joomla\Component\Appsconda\Administrator\View\Publication\HtmlView $this */
...
<form action="<?php echo Route::_('index.php?option=com_appsconda&layout=edit&id=' . $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="adminForm" class="form-validate">
	...
	<div id="validation-form-failed" data-backend-detail="publication" data-message="<?php echo $this->escape(Text::_('JGLOBAL_VALIDATION_FORM_FAILED'));?>">
	</div>
</form>
