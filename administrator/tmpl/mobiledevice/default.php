...
/** @var \Joomla\Component\Appsconda\Administrator\View\Mobiledevice\HtmlView $this */
...
<form action="<?php echo Route::_('index.php?option=com_appsconda&layout=edit&id=' . $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="adminForm" class="form-validate">
	<div class="row-fluid">
		<div class="span10 form-horizontal">
            <fieldset class="adminform">
				...
				<div class="control-group">
					<div class="control-label">
						<?php echo $this->form->getLabel('push'); ?>
					</div>
					<div class="controls">
						<?php echo $this->form->getInput('push'); ?>
					</div>
				</div>
				<div class="control-group">
					<div class="control-label">
				...
				<div class="control-group">
					<div class="control-label">
						<?php echo $this->form->getLabel('devicetoken'); ?>
					</div>
					<div class="controls">
						<?php echo $this->form->getInput('devicetoken'); ?>
					</div>
				</div>
				<div class="control-group">
					<div class="control-label">
	...
	<div id="validation-form-failed" data-backend-detail="mobiledevice" data-message="<?php echo $this->escape(Text::_('JGLOBAL_VALIDATION_FORM_FAILED'));?>">
	</div>
</form>
