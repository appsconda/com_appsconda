...
<?php endif; ?>
<form action="<?php echo Route::_('index.php?option=com_appsconda&view=publications'); ?>" method="get" name="adminForm" id="adminForm">
            ...
            <thead>
                <tr>
                    <th class="item-created_by">
						<?php echo HTMLHelper::_('grid.sort',  'COM_APPSCONDA_HEADING_FRONTEND_LIST_PUBLICATIONS_CREATED_BY', 'a.created_by', $listDirn, $listOrder); ?>
					</th>
                </tr>
            </thead>
            <tbody>
