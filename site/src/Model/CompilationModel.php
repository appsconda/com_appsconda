 ...
 */
class CompilationModel extends FormModel
{
	/**
	...
	public function getItem($pk = null)
	{
		...
		$query->select('a.id, a.appname, a.packagename');
		$query->select('a.entrypage, a.appicon, a.splashimage');
		$query->select('a.splashbackground, a.state, a.ordering');

		$query->from('#__appsconda_compilations as a');
    ...
    public function getForm($data = [], $loadData = true)
    {
        ...
        // Get the form
        $form = $this->loadForm('com_appsconda.compilation', 'compilation', ['control' => 'jform', 'load_data' => $loadData]);
        if (empty($form)) {
            return false;
        }
