 ...
 */
class MobileappapiModel extends FormModel
{
	/**
	...
	public function getItem($pk = null): object
	{
		...
		$query->from('#__appsconda_mobileappapis as a');
    ...
    public function getForm($data = [], $loadData = true)
    {
        ...
        // Get the form
        $form = $this->loadForm('com_appsconda.mobileappapi', 'mobileappapi', array('control' => 'jform', 'load_data' => $loadData));
        if (empty($form)) {
            return false;
        }
