 ...
 */
class MobiledeviceModel extends FormModel
{
	/**
	...
	public function getItem($pk = null)
	{
		...
		$query->select('a.id, a.juserid, a.push');
		$query->select('a.created_time, a.modified_time, a.devicetoken');
		$query->select('a.state, a.ordering');

		$query->from('#__appsconda_mobiledevices as a');
    ...
    public function getForm($data = [], $loadData = true)
    {
        ...
        // Get the form
        $form = $this->loadForm('com_appsconda.mobiledevice', 'mobiledevice', ['control' => 'jform', 'load_data' => $loadData]);
        if (empty($form)) {
            return false;
        }
