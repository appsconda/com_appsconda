 ...
 */
class PublicationModel extends FormModel
{
	/**
	...
	public function getItem($pk = null)
	{
		...
		$query->from('#__appsconda_publications as a');
    ...
    public function getForm($data = [], $loadData = true)
    {
        ...
        // Get the form
        $form = $this->loadForm('com_appsconda.publication', 'publication', ['control' => 'jform', 'load_data' => $loadData]);
        if (empty($form)) {
            return false;
        }
